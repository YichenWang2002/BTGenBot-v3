...
## Running with OpenCode Zen / MiniMax

For OpenAI-compatible LLM repair benchmarks using OpenCode Zen and MiniMax
M2.5, see [docs/OPENCODE_ZEN.md](docs/OPENCODE_ZEN.md). The guide covers
provider environment variables, a minimal curl check, 2-run debugging, and the
full 60-run small benchmark.
